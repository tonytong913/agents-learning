...
| [context-management.md](context-management.md) | 🟡 进行中 | 路线 §4-§5 Context Engineering / 上下文窗口管理与 Token 优化 — System/User Context、Prompt Cache、API 请求组装、InstructionsLoaded、AutoCompact、MicroCompact |
